...
export class EntryDocumentService {
  ...
  viewAllDocumentEntry(status:string): Observable<any> {
    return this._HttpClient.get(`${this.baseURL}/general/entry-documents/all-by-status/${status}`,{ headers: this.getHeadersWithToken() })
  }
