...
@Component({
  selector: 'app-product-moves-reports',
  standalone: true,
  imports: [FormsModule,CommonModule,RouterLinkActive,RouterModule,TranslateModule],
  templateUrl: './product-moves-reports.component.html',
  styleUrl: './product-moves-reports.component.css'
})
export class ProductMovesReportsComponent {
  MoveType = 'all';
  EventType ='all';
  filters = {
    startDate: '',
